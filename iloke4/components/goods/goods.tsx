...
function Goods({navigation}) {
  ...
  const allGoodsData = [
    ...
    {
      id: 5,
      image: require('../image/goods/drawer4.jpg'),
      name: '굿 서랍',
      price: '250,000 원',
      description: '굿 서랍',
    },
    {
      id: 6,
      image: require('../image/goods/chair2.jpg'),
      name: '깔끔 의자',
      price: '210,000 원',
      description: '깔끔한 의자',
    },
    {
      id: 7,
      image: require('../image/goods/drawer5.jpg'),
      name: '모던 서랍',
      price: '400,000 원',
      description: '모던한 서랍',
    },
    {
      id: 8,
      image: require('../image/goods/bed1.jpg'),
      name: '원더플 침대',
      price: '300,000 원',
      description: '원더플한 침대',
    },
    {
      id: 9,
      image: require('../image/goods/bed2.jpg'),
      name: '굿 침대',
      price: '250,000 원',
      description: '굿 침대',
    },
    {
      id: 10,
      image: require('../image/goods/chair3.jpg'),
      name: '깔끔 의자',
      price: '210,000 원',
      description: '깔끔한 의자',
    },
    {
      id: 11,
      image: require('../image/goods/chair4.jpg'),
      name: '와우 의자',
      price: '310,000 원',
      description: '와우한 의자',
    },
    {
      id: 12,
      image: require('../image/goods/chair5.jpg'),
      name: '짱짱 의자',
      price: '250,000 원',
      description: '짱짱한 의자',
    },
    {
      id: 13,
      image: require('../image/goods/chair6.jpg'),
      name: '튼튼 의자',
      price: '270,000 원',
      description: '튼튼한 의자',
    },
    {
      id: 14,
      image: require('../image/goods/sofa1.jpg'),
      name: '튼튼 쇼파',
      price: '410,000 원',
      description: '튼튼한 쇼파',
    },
    {
      id: 15,
      image: require('../image/goods/sofa2.jpg'),
      name: '쩌는 쇼파',
      price: '486,000 원',
      description: '쩌는 쇼파',
    },
